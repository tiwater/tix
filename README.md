...
- `packages/computer/Dockerfile` builds the background node container with Chrome included for browser automation.
...
background worker service Dockerfile path to `packages/computer/Dockerfile`.
