...
Tix 在 [NanoClaw](https://github.com/qwibitai/nanoclaw) 基础上增加了**心智系统**：人格与记忆在交互中形成、跨会话持久化，并可锁定用于生产。透明度和可靠性是不可逾越的底线。
...
当然！Tix 的 `/claw` 和工厂逻辑适用于任何托管在 GitHub 上的项目。
...
Tix 自豪地构建在 **[NanoClaw](https://github.com/qwibitai/nanoclaw)** 的基础之上。我们保留了 NanoClaw 核心的消息路由和任务调度，并扩展了心智系统（人格、记忆、锁定、回滚）与多渠道支持。
