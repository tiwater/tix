...
const agentId = { name: 'agent_id', in: 'path', required: true, type: 'string' };
const sessionId = { name: 'session_id', in: 'path', required: true, type: 'string' };
const scheduleId = { name: 'id', in: 'path', required: true, type: 'string' };
const skillName = { name: 'name', in: 'path', required: true, type: 'string' };
const bindingSchema = {
    type: 'object',
