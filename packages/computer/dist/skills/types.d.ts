...
export type SkillPermissionMode = 'read-only' | 'sandboxed-exec' | 'privileged-exec';
export type SkillDiagnosticSeverity = 'info' | 'warning' | 'error';
export type SkillEntrypointType = 'package-bin' | 'package-main' | 'module' | 'script';
export type SkillAuditAction = 'install' | 'upgrade' | 'enable' | 'disable' | 'remove';
export type SkillApiCompatibilityStatus = 'compatible' | 'incompatible' | 'unspecified';
